...
public class CrosshairConfig implements ICrosshairConfig {
	...
	protected CrosshairConfig(ModConfigSpec.Builder builder) {
		...
		this.crosshairType = builder
			.comment("Crosshair type to use for shoulder surfing. Dynamic is the default for the tactical over-the-shoulder profile so the center of the screen better matches the camera focus.")
