package Infinitygroup.imersive_cam.api.client.world.phys;
...
import Infinitygroup.imersive_cam.api.util.Couple;
...
public sealed abstract class PickContext permits OffsetPickContext, DynamicPickContext, ObstructionPickContext {
	...
	public static class Builder {
		...
		public PickContext build() {
			...
			ICrosshairRenderer crosshairRenderer = IImersiveCam.getInstance().getCrosshairRenderer();
			boolean offsetTrace = this.offsetTrace == null ? !crosshairRenderer.isCrosshairDynamic() : this.offsetTrace;
			IObjectPickerConfig config = IImersiveCam.getInstance().getClientConfig().getObjectPickerConfig();
